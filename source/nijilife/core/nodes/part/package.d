...
*/
module nijilife.core.nodes.part;
import nijilife.integration;
import nijilife.fmt;
import nijilife.core.nodes.drawable;
import nijilife.core;
import nijilife.math;
import bindbc.opengl;
import std.exception;
import std.algorithm.mutation : copy;
public import nijilife.core.nodes.common;
    ...
    SerdeException deserializeFromFghj(Fghj data) {
        ...
        version(InRenderless) {
            if (inIsINPMode()) {
                ...
                assert(0, "Raw nijilife JSON not supported in renderless mode");
            }

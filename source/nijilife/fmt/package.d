...
*/
module nijilife.fmt;
import nijilife.fmt.binfmt;
public import nijilife.fmt.serialize;
import nijilife.integration;
...
ubyte[] inWriteINPPuppetMemory(Puppet p) {
    import nijilife.ver : IN_VERSION;
    ...
    // Write the current used nijilife version to the version_ meta tag.
...
/**
    Writes nijilife puppet to file
*/
...
enum IN_TEX_PNG = 0u; /// PNG encoded nijilife texture
enum IN_TEX_TGA = 1u; /// TGA encoded nijilife texture
enum IN_TEX_BC7 = 2u; /// BC7 encoded nijilife texture
